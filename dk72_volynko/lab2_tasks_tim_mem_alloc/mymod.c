...
/*
 *in this case, this structure is useless but I've decided to use it in order
 *to demonstrate how it can look in tasks where some more dealocations are
 *needed
 */
struct alloc_info {
        u8 arr : 1;
        //some other bit fields may be here ... but not in this case
};
