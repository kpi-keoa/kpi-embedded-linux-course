...
#include <linux/debugfs.h>      // used by debug functions

MODULE_DESCRIPTION("Character device demo");
MODULE_AUTHOR("NazarVolynko");
MODULE_VERSION("1.0");
MODULE_LICENSE("Dual MIT/GPL"); 

u64 beeval = 12;
struct dentry *ddir = NULL;
// struct dentry *dfile = NULL;
...
{
	/**  
	 * TODO: fix to make it zero'ed first (completed)
	 *
			 ...
			 size_t count, loff_t *loff)
{
	...
	if (NULL == item)
		return -EBADF;
	// TODO: Add buffer read logic (completed)
...
//       make these bees twerk (completed)
// TODO: add ioctl to select buffer size (completed)
...
static int __init cdevmod_init(void)
{
	...
	// TODO: add stuff here to make module register itself in /dev (completed)
