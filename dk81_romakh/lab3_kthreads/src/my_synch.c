...
static unsigned long thread_num = 4;    // Amount of simultaneous threads
...
MODULE_PARM_DESC(thread_num, "Amount of simultaneous threads");
...
static int __init mod3_lab_unsynch_init(void)
{
...
static void __exit mod3_lab_unsynch_exit(void)
{
        if (NULL == thread){
...
module_init(mod3_lab_unsynch_init);
module_exit(mod3_lab_unsynch_exit);
