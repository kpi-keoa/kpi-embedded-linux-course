...
static void my_sync_lock(atomic_t *lockv);
static void my_sync_unlock(atomic_t *lockv);

static int thread_func(void *var);

static int __init lab3_my_sync_init(void)
{
...
static void __exit lab3_my_sync_exit(void)
{
...
module_init(lab3_my_sync_init);
module_exit(lab3_my_sync_exit);
