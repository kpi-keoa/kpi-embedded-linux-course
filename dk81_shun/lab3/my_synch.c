...
MODULE_AUTHOR("world_conspiracy"); // More in LICENCE
MODULE_VERSION("0.1");
...
static int __init lab3_mod_init(void)
{
	int i;
...
static void __exit lab3_mod_exit(void)
{
	int i;
...
module_init(lab3_mod_init);
module_exit(lab3_mod_exit);
