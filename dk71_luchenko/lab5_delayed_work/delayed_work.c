...
void wrk_fu (struct work_struct *dat) {
        ...
        printk("wrk_p.kval %lu", wrk_p.kval);
...
void tim_fu (struct timer_list *dat) {
        ...
        printk("tim_p.kval %lu", tim_p.kval);
...
static int __init testmod_init(void)
{
        ...
        tim_thread = kthread_run(tim_th_f, NULL,
                                "tim_t");

        wrk_thread = kthread_run(wrk_th_f, NULL,
                                "wrk_t");
